...
class SysInfo(object):
    ...
    def _get_fs(self):
        ...
        data = dict()
        for dev, dev_data in list(salt.utils.fsutils._blkid().items()):
...
class Query(EnvLoader):
    ...
    def _identity(self, *args, **kwargs):
        ...
        data[EXT] = self._get_external_accounts(list(data[LOCAL].keys())) or 'N/A'
    ...
    def _id_resolv(self, iid, named=True, uid=True):
        ...
        for name, meta in list(self.local_identity[uid and 'users' or 'groups'].items()):
