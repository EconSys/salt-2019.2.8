...
def netdev():
    ...
    def sunos_netdev():
        ...
        for dev in list(__grains__['ip4_interfaces'].keys()) + __grains__['ip6_interfaces']:
            # fetch device info
    ...
    def aix_netdev():
        ...
        fields = []
        procn = None
        for dev in list(__grains__['ip4_interfaces'].keys()) + list(__grains__['ip6_interfaces'].keys()):
            # fetch device info
