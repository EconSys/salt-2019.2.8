            ...
            'Machine': {
                ...
                'policies': {
                    ...
                    'LSAAnonymousNameLookup': {
                        ...
                        'Settings': list(self.enabled_one_disabled_zero_no_not_defined.keys()),
                        'Secedit': {
                    ...
                    'RestrictAnonymousSam': {
                        ...
                        'Settings': list(self.enabled_one_disabled_zero.keys()),
                        'Registry': {
                    ...
                    'ForceGuest': {
                        'Policy': 'Network access: Sharing and security model '
                                  'for local accounts',
                        'lgpo_section': self.security_options_gpedit_path,
                        'Settings': list(self.force_guest.keys()),
                        'Registry': {
                            'Hive': 'HKEY_LOCAL_MACHINE',
                            'Path': 'SYSTEM\\CurrentControlSet\\Control\\Lsa',
                            'Value': 'ForceGuest',
                    ...
                    'WfwDomainState': {
                        ...
                        # - Off
                        # - Not configured
                        'Settings': list(self.firewall_state.keys()),
                        'NetSH': {
                            'Profile': 'domain',
                            'Section': 'state',
                    ...
                    'WfwDomainInboundConnections': {
                        ...
                        # - Allow
                        # - Not configured
                        'Settings': list(self.firewall_inbound_connections.keys()),
                        'NetSH': {
                            'Profile': 'domain',
                    ...
                    'WfwDomainOutboundConnections': {
                        ...
                        # - Allow (default)
                        # - Not configured
                        'Settings': list(self.firewall_outbound_connections.keys()),
                        'NetSH': {
                            'Profile': 'domain',
                            'Section': 'firewallpolicy',
                            'Option': 'Outbound'
                    ...
                    'WfwDomainSettingsNotification': {
                        ...
                        # - No
                        # - Not configured
                        'Settings': list(self.firewall_notification.keys()),
                        'NetSH': {
                            'Profile': 'domain',
                            'Section': 'settings',
                    ...
                    'WfwDomainSettingsLocalFirewallRules': {
                        ...
                        # - No
                        # - Not configured
                        'Settings': list(self.firewall_rule_merging.keys()),
                        'NetSH': {
                            'Profile': 'domain',
                            'Section': 'settings',
                    ...
                    'WfwDomainLoggingAllowedConnections': {
                        ...
                        # - No (default)
                        # - Not configured
                        'Settings': list(self.firewall_log_packets_connections.keys()),
                        'NetSH': {
                            'Profile': 'domain',
                            'Section': 'logging',
                    ...
                    'NoConnectedUser': {
                        ...
                        'Settings': list(self.block_ms_accounts.keys()),
                        'lgpo_section': self.security_options_gpedit_path,
                        'Registry': {
                            'Hive': 'HKEY_LOCAL_MACHINE',
                    ...
                    'ScRemoveOption': {
                        'Policy': 'Interactive logon: Smart card removal '
                                  'behavior',
                        'Settings': list(self.sc_removal_lookup.keys()),
                        'lgpo_section': self.security_options_gpedit_path,
                        'Registry': {
                            'Hive': 'HKEY_LOCAL_MACHINE',
                            'Path': 'Software\\Microsoft\\Windows NT\\'
                    ...
                    'ConsentPromptBehaviorAdmin': {
                        'Policy': 'User Account Control: Behavior of the '
                                  ...
                                  'Admin Approval Mode',
                        'Settings': list(self.uac_admin_prompt_lookup.keys()),
                        'lgpo_section': self.security_options_gpedit_path,
                        'Registry': {
                            'Hive': 'HKEY_LOCAL_MACHINE',
                            'Path': 'Software\\Microsoft\\Windows\\'
                    ...
                    'ConsentPromptBehaviorUser': {
                        ...
                        'Settings': list(self.uac_user_prompt_lookup.keys()),
                        'lgpo_section': self.security_options_gpedit_path,
                        'Registry': {
                            'Hive': 'HKEY_LOCAL_MACHINE',
                            'Path': 'Software\\Microsoft\\Windows\\'
                    ...
                    'DontDisplayLockedUserId': {
                        ...
                        'Settings': list(self.locked_session_user_info.keys()),
                        'lgpo_section': self.security_options_gpedit_path,
                        'Registry': {
                            'Hive': 'HKEY_LOCAL_MACHINE',
                            'Path': 'SOFTWARE\\Microsoft\\Windows\\'
                    ...
                    'EnableS4U2SelfForClaims': {
                        ...
                        'Settings': list(self.s4u2self_options.keys()),
                        'lgpo_section': self.security_options_gpedit_path,
                        'Registry': {
                            'Hive': 'HKEY_LOCAL_MACHINE',
                            'Path': 'System\\CurrentControlSet\\Services\\'
                    ...
                    'SmbServerNameHardeningLevel': {
                        ...
                        'Settings': list(self.smb_server_name_hardening_levels.keys()),
                        'lgpo_section': self.security_options_gpedit_path,
                        'Registry': {
                            'Hive': 'HKEY_LOCAL_MACHINE',
                            'Path': 'System\\CurrentControlSet\\Services\\'
                    ...
                    'AddPrinterDrivers': {
                        'Policy': 'Devices: Prevent users from installing '
                                  'printer drivers',
                        'Settings': list(self.enabled_one_disabled_zero_strings.keys()),
                        'lgpo_section': self.security_options_gpedit_path,
                        'Registry': {
                            'Hive': 'HKEY_LOCAL_MACHINE',
                            'Path': 'System\\CurrentControlSet\\Control\\'
                    ...
                    'LDAPServerIntegrity': {
                        'Policy': 'Domain controller: LDAP server signing '
                                  'requirements',
                        'Settings': list(self.ldap_server_signing_requirements.keys()),
                        'lgpo_section': self.security_options_gpedit_path,
                        'Registry': {
                            'Hive': 'HKEY_LOCAL_MACHINE',
                    ...
                    'AuditAccountLogon': {
                        ...
                        'Settings': list(self.audit_lookup.keys()),
                        'Secedit': {
                    ...
                    'AuditCredentialValidation': {
                        ...
                        'Settings': list(self.advanced_audit_lookup.keys()),
                        'AdvAudit': {
                    ...
                    'ForceKeyProtection': {
                        ...
                        'Settings': list(self.force_key_protection.keys()),
                        'lgpo_section': self.security_options_gpedit_path,
                        'Registry': {
                            'Hive': 'HKEY_LOCAL_MACHINE',
                    ...
                    'LmCompatibilityLevel': {
                        ...
                        'Settings': list(self.lm_compat_levels.keys()),
                        'lgpo_section': self.security_options_gpedit_path,
                        'Registry': {
                            'Hive': 'HKEY_LOCAL_MACHINE',
                            'Path': 'SYSTEM\\CurrentControlSet\\Control\\Lsa',
                    ...
                    'LDAPClientIntegrity': {
                        ...
                        'Settings': list(self.ldap_signing_reqs.keys()),
                        'lgpo_section': self.security_options_gpedit_path,
                        'Registry': {
                            'Hive': 'HKEY_LOCAL_MACHINE',
                    ...
                    'AuditReceivingNTLMTraffic': {
                        ...
                        'Settings': list(self.ntlm_audit_settings.keys()),
                        'lgpo_section': self.security_options_gpedit_path,
                        'Registry': {
                            'Hive': 'HKEY_LOCAL_MACHINE',
                            'Path': 'SYSTEM\\CurrentControlSet\\Control\\LSA\\MSV1_0',
                    ...
                    'AuditNTLMInDomain': {
                        ...
                        'Settings': list(self.ntlm_domain_audit_settings.keys()),
                        'lgpo_section': self.security_options_gpedit_path,
                        'Registry': {
                            'Hive': 'HKEY_LOCAL_MACHINE',
                            'Path': 'SYSTEM\\CurrentControlSet\\Services\\Netlogon\\Parameters',
                    ...
                    'RestrictReceivingNTLMTraffic': {
                        'Policy': 'Network security: Restrict NTLM: Incoming'
                                  ' NTLM traffic',
                        'Settings': list(self.incoming_ntlm_settings.keys()),
                        'lgpo_section': self.security_options_gpedit_path,
                        'Registry': {
                            'Hive': 'HKEY_LOCAL_MACHINE',
                            'Path': 'SYSTEM\\CurrentControlSet\\Control\\LSA\\MSV1_0',
                    ...
                    'RestrictNTLMInDomain': {
                        'Policy': 'Network security: Restrict NTLM: NTLM '
                                  'authentication in this domain',
                        'Settings': list(self.ntlm_domain_auth_settings.keys()),
                        'lgpo_section': self.security_options_gpedit_path,
                        'Registry': {
                            'Hive': 'HKEY_LOCAL_MACHINE',
                            'Path': 'SYSTEM\\CurrentControlSet\\Services\\Netlogon\\Parameters',
                    ...
                    'RestrictSendingNTLMTraffic': {
                        ...
                        'Settings': list(self.outgoing_ntlm_settings.keys()),
                        'lgpo_section': self.security_options_gpedit_path,
                        'Registry': {
                            'Hive': 'HKEY_LOCAL_MACHINE',
                            'Path': 'SYSTEM\\CurrentControlSet\\Control\\Lsa\\MSV1_0',
...
def _buildKnownDataSearchString(reg_key, reg_valueName, reg_vtype, reg_data,
    ...
    if check_deleted:
        ...
        expected_string = b''.join(['['.encode('utf-16-le'),
                                    ...
                                    encoded_semicolon,
                                    six.chr(len(' {0}'.format(chr(0)).encode('utf-16-le'))).encode('utf-32-le'),
                                    encoded_semicolon,
                                    ' '.encode('utf-16-le'),
                                    encoded_null,
                                    ']'.encode('utf-16-le')])
        ...
        expected_string = b''.join(['['.encode('utf-16-le'),
                                    ...
                                    chr(registry.vtype[reg_vtype]).encode('utf-32-le'),
                                    encoded_semicolon,
                                    six.chr(len(this_element_value)).encode('utf-32-le'),
                                    encoded_semicolon,
                                    this_element_value,
                                    ']'.encode('utf-16-le')])
    ...
    if etree.QName(element).localname == 'decimal' and etree.QName(parent_element).localname != 'elements':
        ...
        if etree.QName(element).localname == 'boolean':
            ...
            if element.attrib.get('explicitValue', 'false').lower() == 'true':
                if this_element_value is not None:
                    element_valuenames = [str(k) for k in list(this_element_value.keys())]
                    element_values = [str(v) for v in list(this_element_value.values())]
                ...
                if this_element_value is not None:
                    ...
                    for i, item in enumerate(element_valuenames):
                        expected_string = expected_string + b''.join(['['.encode('utf-16-le'),
                                                                      ...
                                                                      chr(registry.vtype[this_vtype]).encode('utf-32-le'),
                                                                      encoded_semicolon,
                                                                      six.chr(len('{0}{1}'.format(element_values[i],
            ...
            if ELEMENTS_XPATH(admx_policy):
                if element_only_enabled_disabled or this_policy_setting == 'Enabled':
                    ...
                    if element_only_enabled_disabled:
                        if len(list(required_elements.keys())) > 0 \
                                    and len(list(configured_elements.keys())) == len(list(required_elements.keys())):
                            if policy_disabled_elements == len(list(required_elements.keys())):
...
def _getScriptSettingsFromIniFile(policy_info):
    ...
    if os.path.isfile(policy_info['ScriptIni']['IniPath']):
        ...
        if _existingData:
            ...
            if 'Section' in policy_info['ScriptIni'] and policy_info['ScriptIni']['Section'].lower() in [z.lower() for z in list(_existingData.keys())]:
                if 'SettingName' in policy_info['ScriptIni']:
                    log.debug('Need to look for %s', policy_info['ScriptIni']['SettingName'])
                    if policy_info['ScriptIni']['SettingName'].lower() in [z.lower() for z in list(_existingData[policy_info['ScriptIni']['Section']].keys())]:
...
def get_policy_info(policy_name,
    ...
    policy_data = _policy_info()
    if policy_class not in list(policy_data.policies.keys()):
        policy_classes = ', '.join(list(policy_data.policies.keys()))
...
def get(policy_class=None, return_full_policy_names=True,
    ...
    if policy_class is None or policy_class.lower() == 'both':
        policy_class = list(_policydata.policies.keys())
    elif policy_class.lower() not in [z.lower() for z in list(_policydata.policies.keys())]:
        msg = 'The policy_class {0} is not an available policy class, please ' \
              'use one of the following: {1}, Both'
        raise SaltInvocationError(
            msg.format(policy_class, ', '.join(list(_policydata.policies.keys()))))
    else:
        policy_class = [policy_class.title()]
