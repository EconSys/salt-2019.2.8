...
def update_dvs(dvs_dict, dvs, service_instance=None):
    ...
    for prop in list(dvs_config.__dict__.keys()):
...
def update_vm(vm_name, cpu=None, memory=None, image=None, version=None,
    ...
    difference_keys = list(diffs.keys())
