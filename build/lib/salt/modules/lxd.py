...
def container_list(list_names=False, remote_addr=None,
    ...
    return list(map(_pylxd_model_to_dict, containers))
...
def profile_list(list_names=False, remote_addr=None,
    ...
    return list(map(_pylxd_model_to_dict, profiles))
...
def image_list(list_aliases=False, remote_addr=None,
    ...
    return list(map(_pylxd_model_to_dict, images))
...
def sync_config_devices(obj, newconfig, newdevices, test=False):
    ...
    newconfig = dict(list(zip(
        list(map(six.text_type, list(newconfig.keys()))),
        list(map(six.text_type, list(newconfig.values())))
    )))
    cck = set(newconfig.keys())

    obj.config = dict(list(zip(
        list(map(six.text_type, list(obj.config.keys()))),
        list(map(six.text_type, list(obj.config.values())))
    )))
...
def _pylxd_model_to_dict(obj):
    ...
    marshalled = {}
    for key in list(obj.__attributes__.keys()):
        if hasattr(obj, key):
