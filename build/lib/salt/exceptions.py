...
class SaltException(Exception):
    ...
    def __init__(self, message=''):
        ...
        if six.PY3 or isinstance(message, str):  # pylint: disable=incompatible-py3-code,undefined-variable
            ...
            self.message = self.strerror = str(message)  # pylint: disable=incompatible-py3-code,undefined-variable
