...
def present(host, groups, interfaces, **kwargs):
    ...
    def _interface_format(interfaces_data):
        ...
        for interface in interfaces_json:
            for intf in interface:
                ...
                for intf_val in interface[intf]:
                    for key, value in list(intf_val.items()):
        ...
        for key, value in list(interfaces_dict.items()):
    ...
    for inv_item in inventory:
        for k, v in list(inv_item.items()):
    ...
    if host_exists:
        ...
        if cur_inventory:
            ...
            cur_inventory = {k: v for k, v in list(cur_inventory.items()) if v}
