...
class KiwiExporter(object):
    ...
    def load(self, **descr):
        ...
        :return:
        '''
        for obj, data in list(descr.items()):
    ...
    def _set_preferences(self, node):
        ...
        for disk_id, disk_data in list(self._data.system.get('disks', {}).items()):
    ...
    def _set_users(self, node):
        ...
        for u_name, u_data in list(shadow.items()):
    ...
    def _set_repositories(self, node):
        ...
        for repo_id, repo_data in list(self._data.software.get('repositories', {}).items()):
    ...
    def _set_packages(self, node):
        ...
        if self.__grains__.get('os_family', '') == 'Suse':
            for ptn_id, ptn_data in list(self._data.software.get('patterns', {}).items()):
