...
def output(data, **kwargs):  # pylint: disable=unused-argument
    ...
    local_masters = [key for key in list(data.keys()) if key.endswith('.local_master')]
    orchestrator_output = 'retcode' in list(data.keys()) and len(local_masters) == 1
        ...
        for tname in sorted(
            ...
            if 'data' in ret:
                if isinstance(ret['data'], list):
                    ...
                    for key, value in list(ret['data'].items()):
