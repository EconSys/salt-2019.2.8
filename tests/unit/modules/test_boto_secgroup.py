...
class BotoSecgroupTestCase(TestCase, LoaderModuleMockMixin):
    ...
    def test__split_rules(self):
        ...
        '''
        rules = [OrderedDict([('ip_protocol', 'tcp'), ('from_port', 22), ('to_port', 22), ('grants', [OrderedDict([('cidr_ip', '0.0.0.0/0')])])]),
                 OrderedDict([('ip_protocol', 'tcp'), ('from_port', 80), ('to_port', 80), ('grants', [OrderedDict([('cidr_ip', '0.0.0.0/0')])])])]
        split_rules = [{'to_port': 22, 'from_port': 22, 'ip_protocol': 'tcp', 'cidr_ip': '0.0.0.0/0'},
                       {'to_port': 80, 'from_port': 80, 'ip_protocol': 'tcp', 'cidr_ip': '0.0.0.0/0'}]
    ...
    def test_get_config_single_rule_group_name(self):
        ...
        to_port = 22
        cidr_ip = '0.0.0.0/0'
        rules_egress = [{'to_port': None, 'from_port': None, 'ip_protocol': '-1', 'cidr_ip': '0.0.0.0/0'}]
        ...
        expected_get_config_result = OrderedDict([('name', group.name), ('group_id', group.id), ('owner_id', '123456789012'),
