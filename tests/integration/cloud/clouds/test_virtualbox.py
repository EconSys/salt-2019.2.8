...
class VirtualboxProviderTest(VirtualboxCloudTestCase):
    ...
    def test_cloud_create(self):
        ...
        self.assertIn(INSTANCE_NAME, list(machines.keys()))
    ...
    def test_cloud_list(self):
        ...
        for name, machine in six.iteritems(machines):
            if six.PY3:
                self.assertCountEqual(expected_attributes, list(machine.keys()))
            else:
                self.assertItemsEqual(expected_attributes, list(machine.keys()))
    ...
    def test_cloud_list_full(self):
        ...
        self.assertGreaterEqual(len(names), 1, "No machines found")
        for name, machine in six.iteritems(machines):
            self.assertGreaterEqual(len(list(machine.keys())), expected_minimal_attribute_count)
    ...
    def test_cloud_destroy(self):
        ...
        self.assertIn(INSTANCE_NAME, list(ret.keys()))
...
class XpcomConversionTests(TestCase):
    ...
    def test_override_attributes(self):
        ...
        ret = vb_xpcom_to_attribute_dict(xpc, attributes=list(expected_dict.keys()))
    ...
    def test_extra_attributes(self):
        ...
        ret = vb_xpcom_to_attribute_dict(
            ...
            extra_attributes=list(expected_extras.keys())
        )
    ...
    def test_extra_nonexistent_attributes(self):
        ...
        ret = vb_xpcom_to_attribute_dict(xpcom, extra_attributes=list(expected_extra_dict.keys()))
